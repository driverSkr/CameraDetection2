...
object BluetoothHelper {
    ...
    fun addDevice(device: BluetoothDevice, rssi: Int?, localBluetoothMac: String, suspiciousDevices: SnapshotStateList<com.ethan.cameradetection2.model.BluetoothDevice>, trustedDevices: SnapshotStateList<com.ethan.cameradetection2.model.BluetoothDevice>) {
        ...
        val myDevice = com.ethan.cameradetection2.model.BluetoothDevice(
            name = name,
            type = deviceType,
            mac = mac,
