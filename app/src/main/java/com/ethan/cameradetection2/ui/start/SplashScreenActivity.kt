package com.ethan.cameradetection2.ui.start
...
import com.ethan.cameradetection2.ui.start.page.SplashScreenPage
import com.skydoves.bundler.intentOf

class SplashScreenActivity : BaseActivityVBind<LayoutComposeContainerBinding>() {

    companion object {
        fun launch(context: Context) {
            context.intentOf<SplashScreenActivity> {
