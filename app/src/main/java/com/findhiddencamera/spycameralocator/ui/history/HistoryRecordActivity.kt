package com.findhiddencamera.spycameralocator.ui.history
...
import com.findhiddencamera.spycameralocator.ui.history.page.HistoryRecordPage
import com.skydoves.bundler.intentOf

class HistoryRecordActivity : BaseActivityVBind<LayoutComposeContainerBinding>() {

    companion object {
        fun launch(context: Context) {
            context.intentOf<HistoryRecordActivity> {
