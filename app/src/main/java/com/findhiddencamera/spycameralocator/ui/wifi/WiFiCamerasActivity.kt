package com.findhiddencamera.spycameralocator.ui.wifi
...
import com.findhiddencamera.spycameralocator.ui.wifi.page.WiFiCamerasPage
import com.skydoves.bundler.intentOf

class WiFiCamerasActivity : BaseActivityVBind<LayoutComposeContainerBinding>() {

    companion object {
        fun launch(context: Context) {
            context.intentOf<WiFiCamerasActivity> {
